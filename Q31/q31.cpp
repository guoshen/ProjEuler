...
D[200, {200,100,50,20,10,5,2,1}]= D[200,{100,50,20,10,5,2,1}]+D[0,{100,50,20,10,5,2,1}];

Number of ways to make 200p using {200,100,50,20,10,5,2,1} coins is the sum of:
the number of ways to make 200p using {100,50,20,10,5,2,1} coins using 0 200p coins
and the number of ways to make 200p using {100,50,20,10,5,2,1} coins using 1 200p coin
